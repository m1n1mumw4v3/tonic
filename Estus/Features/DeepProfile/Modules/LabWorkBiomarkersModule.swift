...
enum LabWorkBiomarkersModule {
    static let config = DeepProfileModuleConfig(
        ...
        questions: [
            ...
            DeepProfileQuestion(
                id: "lab_crp_inflammation",
                text: "Do you know your CRP (C-reactive protein) level?",
                subtext: "A marker of systemic inflammation",
                inputType: .singleSelect([
                    SelectOption(value: "elevated", label: "Elevated"),
                    SelectOption(value: "normal", label: "Normal"),
                    SelectOption(value: "unknown", label: "I don't know"),
                ]),
                isOptional: true
            ...
            DeepProfileQuestion(
                id: "lab_homocysteine",
                text: "Do you know your homocysteine level?",
                subtext: "Elevated levels may indicate B-vitamin needs",
                inputType: .singleSelect([
                    SelectOption(value: "elevated", label: "Elevated"),
                    SelectOption(value: "normal", label: "Normal"),
                    SelectOption(value: "unknown", label: "I don't know"),
