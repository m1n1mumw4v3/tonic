    ...
    static let config = DeepProfileModuleConfig(
        ...
        questions: [
            ...
            DeepProfileQuestion(
                ...
                text: "Where do you most commonly experience pain or stiffness?",
                inputType: .singleSelect([
                    SelectOption(value: "joints", label: "Joints"),
                    SelectOption(value: "tendons_ligaments", label: "Tendons / ligaments"),
                    SelectOption(value: "lower_back", label: "Lower back"),
                    SelectOption(value: "muscles", label: "Muscles"),
                    SelectOption(value: "multiple_areas", label: "Multiple areas"),
                    SelectOption(value: "none", label: "None"),
                ])
            ),
            DeepProfileQuestion(
                id: "recovery_workout_intensity",
                text: "How would you describe your typical workout intensity?",
                inputType: .singleSelect([
                    SelectOption(value: "light", label: "Light"),
                    SelectOption(value: "moderate", label: "Moderate"),
                    SelectOption(value: "high", label: "High"),
                    SelectOption(value: "very_high", label: "Very high"),
                ])
            ),
            DeepProfileQuestion(
                id: "recovery_bone_health",
                text: "Have you been diagnosed with or are you concerned about bone density loss?",
                inputType: .singleSelect([
                    SelectOption(value: "yes_diagnosed", label: "Yes, diagnosed"),
                    SelectOption(value: "yes_concerned", label: "Yes, concerned"),
                    SelectOption(value: "no", label: "No"),
                    SelectOption(value: "not_sure", label: "Not sure"),
                ])
            ),
            DeepProfileQuestion(
                id: "recovery_48hr_recovery",
                text: "Do you feel fully recovered within 48 hours of an intense workout?",
                inputType: .singleSelect([
                    SelectOption(value: "usually", label: "Usually"),
                    SelectOption(value: "sometimes", label: "Sometimes"),
                    SelectOption(value: "rarely", label: "Rarely"),
                    SelectOption(value: "no_intense", label: "I don't exercise intensely"),
                ])
            ),
            DeepProfileQuestion(
