            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        // Headline
                        HeadlineText(
                            text: "Estus takes the guesswork out of feeling your best.",
                            fontSize: 22
                        )
                ...
                HStack(alignment: .top, spacing: 4) {
                    ...
                    Text("Estus may earn a commission on partner purchases. Recommendations are always based on your profile.")
