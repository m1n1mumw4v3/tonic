...
class LocalStorageService: DataStore {
    ...
    private enum Keys {
        static let profile = "estus_user_profile"
        static let plan = "estus_active_plan"
        static let checkIns = "estus_check_ins"
        static let streak = "estus_streak"
        static let insights = "estus_insights"
        static let deepProfile = "estus_deep_profile"
    }
